...
import { AccessTheme } from "../ThemeContext/ThemeContext";
import "./header.css";

const Header = () => {
	const { setTheme } = AccessTheme();
	...
	const sun = (
		<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' id='sun'>
	...
	return (
		<header>
			<div id='logo' onClick={onClickGoToHome}>
				News
			</div>
			<div className='theme-toggle' onClick={handleThemeToggle}>
				<label for='themecheckbox'>{icon ? sun : moon}</label>
			</div>
		</header>
	);
};
